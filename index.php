    ...
    <div class="container" id="container">
        <div class="form-container sign-up-container">
            <form action="./auth/register_Process.php" id="register_Form" method="post" >
                ...
                <input type="email" placeholder="Email" id="register_email" name="register_email" autocomplete="current-password" required/>
                <input type="password" placeholder="Password" id="register_password" name="register_password" autocomplete="current-password" required/>
        ...
        <div class="form-container sign-in-container">
            <form action="./auth/login_Process.php" id="login_Form" method="post" >
                ...
                <input type="email" placeholder="Email" id="email" name="email" autocomplete="current-password" required/>
